<template>
  ...
  <div id="main-container" class="container">
    ...
    <div id="session" v-if="session">
      ...
      <div id="main-video" class="smallvideo">
        <user-video :stream-manager="mainStreamManager"/>
      </div>

      <div id="session-footer">
        <p style="font-weight: bold">Aktuelle Übung: {{ (isPause) ? 'Pause' : currentExercise[currentIndex] }} </p>
      </div>
    </div>
    ...
    <!--   TODO: Countdown Timer noch anzeigen   -->
...
export default {
  ...
  data() {
    return {
      ...
      currentExercise: ["Lunges", "Squats", "Squat Jump", "Shuffle Run"],
      currentIndex: 0,
